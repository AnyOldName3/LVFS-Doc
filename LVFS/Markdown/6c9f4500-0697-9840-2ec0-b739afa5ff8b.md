...
**C#**<br />
``` C#
protected bool PredecessorTryUnlockFileRegion(
	string path,
	long startOffset,
	long length,
...
**VB**<br />
``` VB
Protected Function PredecessorTryUnlockFileRegion ( 
	path As String,
	startOffset As Long,
	length As Long,
...
``` C++
protected:
bool PredecessorTryUnlockFileRegion(
	String^ path, 
...
**F#**<br />
``` F#
member PredecessorTryUnlockFileRegion : 
        path : string * 
        startOffset : int64 * 
        length : int64 * 
